...
// Source:
// https://github.com/cilium/cilium/blob/e896ab6a0c4caf5cd7f394350dc68a2a2bf2bc9a/bpf/include/bpf/builtins.h
...
static __always_inline __maybe_unused void __bpf_memset_builtin(void *d, __u8 c,
                                                                __u64 len) {
...
// TODO: re-enable once all __builtin_memset() are replaced with the optimized
// version #define __builtin_memset __bpf_no_builtin_memset

static __always_inline __maybe_unused
__nobuiltin("memset") void bpf_memset(void *d, int c, __u64 len) {
...
/* Redirect any direct use in our code to throw an error. */
// TODO: re-enable once all __builtin_memcpy() are replaced with the optimized
// version #define __builtin_memcpy __bpf_no_builtin_memcpy

static __always_inline __maybe_unused
__nobuiltin("memcpy") void bpf_memcpy(void *d, const void *s, __u64 len) {
...
/* Redirect any direct use in our code to throw an error. */
// TODO: re-enable once all __builtin_memcmp() are replaced with the optimized
// version #define __builtin_memcmp __bpf_no_builtin_memcmp
...
static __always_inline void __bpf_memmove_bwd(void *d, const void *s,
                                              __u64 len) {
  /* Our internal memcpy implementation walks backwards by default. */
  __bpf_memcpy(d, s, len);
}

static __always_inline void __bpf_memmove_fwd(void *d, const void *s,
                                              __u64 len) {
#if __clang_major__ >= 10
  if (!__builtin_constant_p(len))
    __throw_build_bug();
...
static __always_inline __maybe_unused
__nobuiltin("memmove") void bpf_memmove(void *d, const void *s, __u64 len) {
