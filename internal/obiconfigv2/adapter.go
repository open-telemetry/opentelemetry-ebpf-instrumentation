...
func applyCapture(cfg *obi.Config, src *obiv2.Extension) {
	...
	setString((*string)(&cfg.Routes.IgnoreMode), nestedMap(httpCfg, "routes"), "ignore_mode")
	...
	setString(&cfg.NetworkFlows.GeoIP.MaxMind.CountryPath, nestedMap(network, "enrichment", "geo_ip", "maxmind"), "country_path")
	setString(&cfg.NetworkFlows.GeoIP.MaxMind.ASNPath, nestedMap(network, "enrichment", "geo_ip", "maxmind"), "asn_path")
