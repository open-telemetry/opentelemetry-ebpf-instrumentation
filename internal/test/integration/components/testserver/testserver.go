...
import (
	...
	"go.opentelemetry.io/obi/internal/test/integration/components/testserver/gorilla"
	"go.opentelemetry.io/obi/internal/test/integration/components/testserver/gorillamid"
	"go.opentelemetry.io/obi/internal/test/integration/components/testserver/gorillamid2"
	grpctest "go.opentelemetry.io/obi/internal/test/integration/components/testserver/grpc/server"
	"go.opentelemetry.io/obi/internal/test/integration/components/testserver/jsonrpc"
	"go.opentelemetry.io/obi/internal/test/integration/components/testserver/std"
)
