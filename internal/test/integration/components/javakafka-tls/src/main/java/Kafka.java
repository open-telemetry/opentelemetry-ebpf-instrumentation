...
public class Kafka {
    private static String KAFKA_SERVER="kafka";
    ...
    public static void main(String[] args) {
        try {
            ...
            producerProps.put("bootstrap.servers", KAFKA_SERVER + ":9094");
            producerProps.put("security.protocol", "SSL");
            producerProps.put("ssl.truststore.location", "./certs/kafka.truststore.jks");
            ...
            consumerProps.put("bootstrap.servers", KAFKA_SERVER + ":9094");
            consumerProps.put("security.protocol", "SSL");
            consumerProps.put("ssl.truststore.location", "./certs/kafka.truststore.jks");
