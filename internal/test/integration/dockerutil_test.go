...
const (
	...
	imgNginx       = img.Docker("library/nginx:1.31.4@sha256:b34848eff6db786b6b1282d3a9c3fd0b5563dfb6d261df4923378b419e0d24f0")
	...
	created, err := dockerPool.Client().ContainerCreate(t.Context(), client.ContainerCreateOptions{
		...
		Config: &container.Config{
			...
			Env: append([]string{
				...
				"OTEL_EBPF_METRICS_FEATURES=application,application_sizes,application_span_otel",
				"OTEL_EBPF_PROMETHEUS_FEATURES=application,application_sizes,application_span_otel",
