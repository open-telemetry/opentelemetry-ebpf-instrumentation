	...
	tests := []phpHarvestCase{
		{
			...
			route: "/api/echo/{echo}", service: "obi/php-harvest-laravel", version: "1.1.0", argument: "laravel",
		},
		{
			name: "Symfony", url: "http://localhost:8083", path: "/api/symfony/echo/symfony",
			route: "/api/symfony/echo/{value}", service: "obi/php-harvest-symfony", version: "2.2.0", argument: "symfony",
		},
		{
