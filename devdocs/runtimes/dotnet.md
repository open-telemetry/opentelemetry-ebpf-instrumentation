...
.NET 8 processes on Linux through their diagnostic Unix sockets.
...
Enable .NET 8 runtime metrics through the shared runtime metrics feature:
...
.NET 8 runtime metrics flow through diagnostic IPC and EventPipe to the shared
...
This collector supports .NET 8 only. Unsupported CLR versions are skipped.
