...
## Protocol Overview
The kafka protocol definition can be found [here](https://kafka.apache.org/protocol#protocol_messages)
...
each message type has its own version from which it becomes flexible, you can find it in the `flexibleVersions` json field in the message definitions [here](https://github.com/apache/kafka/tree/9983331d917fe8f57c37c88f0749b757e5af0c87/clients/src/main/resources/common/message).
