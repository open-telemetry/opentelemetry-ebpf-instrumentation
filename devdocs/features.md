...
|:------------------------------|:----------:|---------:|---------|:------:|-------------------:|------------:
| net/http                      |    HTTP    |      All | All     |  Yes   |                Yes |         N/A 
| golang.org/x/net/http2        |    HTTP    |      All | All     |  Yes   |                Yes |         N/A 
| github.com/gorilla/mux        |    HTTP    |      All | All     |  Yes   |                Yes |         N/A 
| github.com/gin-gonic/gin      |    HTTP    |      All | All     |  Yes   |                Yes |         N/A 
| google.golang.org/grpc        |    gRPC    |      All | All     |  Yes   |                Yes |         N/A 
| net/rpc/jsonrpc               |  JsonRPC   |      All | All     |  Yes   |                 No |         N/A 
| database/sql                  |    SQL     |      All | All     |  Yes   |                 No |         N/A 
| github.com/lib/pq             | PostgreSQL |      All | All     |  Yes   |                 No |         N/A 
| github.com/redis/go-redis/v9  |   Redis    |      All | All     |  Yes   |                 No |         N/A 
| github.com/segmentio/kafka-go |   Kafka    |      All | All     |  Yes   |                 No |         N/A 
| github.com/IBM/sarama         |   Kafka    |      All | All     |  Yes   |                 No |         N/A 
| go.mongodb.org/mongo-driver   |  MongoDB   |      All | All     |  Yes   |                 No |         N/A 