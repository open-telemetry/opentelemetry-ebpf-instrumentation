...
| `ebpf.bpf_debug` | `boolean` | `OTEL_EBPF_BPF_DEBUG` | `false` |  | Yes | Use bpf_debug_mode instead. |
| `ebpf.bpf_debug_mode` | `string` | `OTEL_EBPF_BPF_DEBUG_MODE` | `disabled` | ``, `all`, `disabled` |  | Enables logging of eBPF program events to the selected outputs. |
