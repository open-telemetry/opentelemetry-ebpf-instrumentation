...
func TestBasicPipeline(t *testing.T) {
	...
	gb := newGraphBuilder(&obi.Config{
		...
		Metrics:      cfg,
		Attributes:   obi.Attributes{Select: allMetrics, InstanceID: tracescfg.InstanceIDConfig{OverrideHostname: "the-host"}},
...
func TestTracerPipeline(t *testing.T) {
	...
	gb := newGraphBuilder(&obi.Config{
		...
		Attributes: obi.Attributes{InstanceID: tracescfg.InstanceIDConfig{OverrideHostname: "the-host"}},
...
func TestMergedMetricsTracePipeline(t *testing.T) {
	...
	gb := newGraphBuilder(&obi.Config{
		...
		Attributes: obi.Attributes{
			Select:                         allMetrics,
			InstanceID:                     tracescfg.InstanceIDConfig{OverrideHostname: "the-host"},
...
func TestRouteConsolidation(t *testing.T) {
	...
	gb := newGraphBuilder(&obi.Config{
		...
		Attributes: obi.Attributes{Select: allMetricsBut("client.address", "url.path"), InstanceID: tracescfg.InstanceIDConfig{OverrideHostname: "the-host"}},
