...
type CommonTracer interface {
	...
	// BpfObjects returns a slice of object pointers matching the specs returned by LoadSpecs().
	// Each object will be populated by spec.LoadAndAssign() for the corresponding spec.
	BpfObjects() []any
...
type Tracer interface {
	PIDsAccounter
	KprobesTracer
	// Constants returns a slice of constant maps, one per spec from LoadSpecs().
	// Each map contains constants to be overridden into the corresponding eBPF program.
