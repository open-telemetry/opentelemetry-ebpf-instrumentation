...
func ProcessPossibleKafkaEvent(event *TCPRequestInfo, pkt *LargeBuffer, rpkt *LargeBuffer, kafkaTopicUUIDToName *simplelru.LRU[kafkaparser.UUID, string]) (*KafkaInfo, bool, error) {
	...
	if err != nil {
		...
		// Reset cursors before retrying with swapped buffers.
		if pkt != nil {
			pkt.ResetRead()
		}
		if rpkt != nil {
...
func ProcessKafkaEvent(pkt *LargeBuffer, rpkt *LargeBuffer, kafkaTopicUUIDToName *simplelru.LRU[kafkaparser.UUID, string]) (*KafkaInfo, bool, error) {
	if pkt == nil {
...
func processProduceRequest(pkt *LargeBuffer, hdr *kafkaparser.KafkaRequestHeader) (*KafkaInfo, bool, error) {
...
func processFetchRequest(pkt *LargeBuffer, hdr *kafkaparser.KafkaRequestHeader, kafkaTopicUUIDToName *simplelru.LRU[kafkaparser.UUID, string]) (*KafkaInfo, bool, error) {
...
func processMetadataResponse(rpkt *LargeBuffer, hdr *kafkaparser.KafkaRequestHeader, kafkaTopicUUIDToName *simplelru.LRU[kafkaparser.UUID, string]) (*KafkaInfo, bool, error) {
	if rpkt == nil {
...
func ProcessKafkaRequest(pkt *LargeBuffer, kafkaTopicUUIDToName *simplelru.LRU[kafkaparser.UUID, string]) (*KafkaInfo, bool, error) {
	if pkt == nil {
		return nil, true, errors.New("nil request buffer")
	}
	hdr, err := kafkaparser.ParseKafkaRequestHeader(pkt)
