...
func handlePostgres(parseCtx *EBPFParseContext, event *TCPRequestInfo, requestBuffer, responseBuffer *LargeBuffer) (request.Span, error) {
	var (
		hasSpan         bool
	...
	// ReadN(remaining) for response — materialised once for sqlprune.SQLParseError.
