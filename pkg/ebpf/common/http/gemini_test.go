...
func TestGeminiSpan_GenerateContent(t *testing.T) {
	...
	assert.Equal(t, 12, ai.Output.UsageMetadata.PromptTokenCount.Value())
	assert.Equal(t, 18, ai.Output.UsageMetadata.CandidatesTokenCount.Value())
	assert.Equal(t, 30, ai.Output.UsageMetadata.TotalTokenCount.Value())
...
func TestGeminiSpan_StreamResponse(t *testing.T) {
	...
	assert.Equal(t, 12, ai.Output.UsageMetadata.PromptTokenCount.Value())
	assert.Equal(t, 6, ai.Output.UsageMetadata.CandidatesTokenCount.Value())
	assert.Equal(t, 18, ai.Output.UsageMetadata.TotalTokenCount.Value())
