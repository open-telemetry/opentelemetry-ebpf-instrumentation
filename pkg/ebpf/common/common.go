...
const (
	...
	EventTypeKHTTP          = 6  // HTTP Events generated by kprobes  EVENT_K_HTTP_REQUEST
	EventTypeKHTTP2         = 7  // HTTP2/gRPC Events generated by kprobes  EVENT_K_HTTP2_REQUEST
	EventTypeTCP            = 8  // Unknown TCP protocol to be classified by user space  EVENT_TCP_REQUEST
	EventTypeGoSarama       = 9  // Kafka client for Go (Shopify/IBM Sarama)  EVENT_GO_KAFKA
	EventTypeGoRedis        = 10 // Redis client for Go  EVENT_GO_REDIS
	EventTypeGoKafkaGo      = 11 // Kafka-Go client from Segment-io  EVENT_GO_KAFKA_SEG
	EventTypeTCPLargeBuffer = 12 // Dynamically sized TCP buffers  EVENT_TCP_LARGE_BUFFER
	EventOTelSDKGo          = 13 // OTel SDK manual span  EVENT_GO_SPAN
	EventTypeGoMongo        = 14 // Go MongoDB spans  EVENT_GO_MONGO
	EventTypeFailedConnect  = 15 // Failed Connections  EVENT_FAILED_CONNECT
	EventTypeDNS            = 16 // DNS events EVENT_DNS_REQUEST
)
