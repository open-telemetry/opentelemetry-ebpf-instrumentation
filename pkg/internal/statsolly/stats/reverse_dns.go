...
type ReverseDNS struct {
	...
	Type string `yaml:"type" env:"OTEL_EBPF_STATS_REVERSE_DNS_TYPE" validate:"oneof=none local ebpf" jsonschema:"type=string,enum=none,enum=local,enum=ebpf"`
	...
	CacheLen int `yaml:"cache_len" env:"OTEL_EBPF_STATS_REVERSE_DNS_CACHE_LEN" validate:"gte=0"`
	...
	// up again.
	CacheTTL time.Duration `yaml:"cache_expiry" env:"OTEL_EBPF_STATS_REVERSE_DNS_CACHE_TTL" validate:"gte=0"`
}
