...
func (p *Tracer) GetRuntimeMapSizes(cfg *obi.Config) map[string]config.MapSettings {
	return map[string]config.MapSettings{
		//"ongoing_client_connections":      ,
		//"ongoing_redis_requests":          ,
		//"incoming_trace_map":              ,
		//"ongoing_grpc_header_writes":      ,
		//"newproc1":                        ,
		//"ongoing_sql_queries":             ,
		//"go_ongoing_http_client_requests": ,
		//"pq_hostnames":                    ,
		//"ongoing_grpc_client_requests":    ,
		//"produce_traceparents":            ,
		"span_names":         cfg.EBPF.MapsConfig.MapOverrides.SpanNames,
		"outgoing_trace_map": cfg.EBPF.MapsConfig.MapOverrides.OutgoingTraceMap,
		//"go_trace_map":                    ,

		//"events":                            , // NO
		// "grpc_framer_invocation_map":        ,
		// "redis_writes":                      ,
		// "ongoing_produce_topics":            ,
		// "msg_buffer_mem":                    ,
		// "trace_map":                         ,
		// "temp_header_mem_store":             ,
		// "ongoing_grpc_operate_headers":      ,
		// "ongoing_http_server_requests":      ,
		// "framer_invocation_map":             ,
		// "transport_new_client_invocations":  ,
		// "produce_requests":                  ,
		// "tp_char_buf_mem":                   ,
		// "http2_req_map":                     ,
		// "http2_server_requests_tp":          ,
		// "fetch_requests":                    ,
		// "go_offsets_map":                    ,
		// "ongoing_mongo_requests":            ,
		// "ongoing_server_connections":        ,
		// "header_req_map":                    ,
		// "ongoing_grpc_server_requests":      ,
		// "ongoing_kafka_requests":            ,
		// "active_spans":                      ,
		// "span_mem":                          ,
		// "debug_events":                      ,
		// "ongoing_grpc_transports":           ,
		// "go_ongoing_http":                   ,
		// "ongoing_produce_messages":          ,
		// "ongoing_goroutines":                ,
		// "ongoing_grpc_request_status":       ,
		// "kafka_requests":                    ,
		// "ongoing_http_client_requests_data": ,
		// "cached_grpc_client_connections":    ,
		// "ongoing_streams":                   ,
	}
}
