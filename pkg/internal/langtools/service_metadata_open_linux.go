...
func OpenServiceMetadataFile(path string, maxServiceMetadataBytes int64) (*os.File, bool) {
	...
	if stat.Mode&unix.S_IFMT != unix.S_IFREG || stat.Size > maxServiceMetadataBytes {
		unix.Close(fd)
		return nil, true
	}
