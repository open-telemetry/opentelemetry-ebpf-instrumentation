...
func Fixture() *TracesQuery {
	...
	err := json.Unmarshal([]byte(`{"data":[{"traceID":"eae56fbbec9505c102e8aabfc6b5c481","spans":[{"traceID":"eae56fbbec9505c102e8aabfc`+
		...
		`:[{"key":"otel.library.name","type":"string","value":"go.opentelemetry.io/obi"},{"key":"span.kind"`+
		...
		`","value":"go.opentelemetry.io/obi"},{"key":"span.kind","type":"string","value":"internal"},{"key"`+
		...
		`artTime":1686641491452470,"duration":3322,"tags":[{"key":"otel.library.name","type":"string","value":"go.opentelemetry.io/obi"`+
		...
		`","value":"go.opentelemetry.io/obi"},{"key":"http.method","type":"string","value":"GET"},{"key":"h`+
		...
		`otel.library.name","type":"string","value":"go.opentelemetry.io/obi"},{"key":"span.kind","type":"s`+
